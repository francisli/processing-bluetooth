...
public class Bluetooth implements DiscoveryListener, Runnable {
    ...
    public static final long UUID_OPP = 0x1105;
    ...
    */
    ...
    java.lang.reflect.Method serviceSendProgressEventMethod;
    ...
    private void registerWithParent() {
    	...
    	try {
      		serviceSendProgressEventMethod =
        	parent.getClass().getMethod("serviceSendProgressEvent",
	...
	public void serviceDiscoveryCompleteEvent(Service[] s) {
        ...
        public void serviceSendProgressEvent(int bytesRead, int totalBytesRead, int totalBytes) throws Throwable {
            if (serviceSendProgressEventMethod != null) {
                try {
                    serviceSendProgressEventMethod.invoke(parent, new Object[] { new Integer(bytesRead), new Integer(totalBytesRead), new Integer(totalBytes) });
